...
public static class DependencyObjectExtensions
{
    public static T GetValueThreadSafe<T>(this System.Windows.DependencyObject obj, System.Windows.DependencyProperty p)
    {
        return (T)obj.Dispatcher.Invoke(System.Windows.Threading.DispatcherPriority.Background,
            (System.Windows.Threading.DispatcherOperationCallback)delegate { return obj.GetValue(p); }, p);
    }


    public static void SetValueThreadSafe(this System.Windows.DependencyObject obj, System.Windows.DependencyProperty p,
        object value)
    {
        obj.Dispatcher.BeginInvoke(System.Windows.Threading.DispatcherPriority.Background,
            (System.Threading.SendOrPostCallback)delegate { obj.SetValue(p, value); }, value);
    }
    ...
    public static object FindNameUpTree(this System.Windows.DependencyObject child, string controlToFindName)
    {
        ...
        do
        {
            ...
            currentName =
                current.GetValue(System.Windows.Controls.Control
                    .NameProperty) as string; // if it doesn't have one this should be null right???
    ...
    public static System.Windows.FrameworkElement FindNameDownTree(this System.Windows.DependencyObject parent,
        string controlToFindName, List<System.Windows.FrameworkElement> matchingElements = null)
    {
        ...
        if (matchingElements == null)
            matchingElements =
                new List<System.Windows.FrameworkElement>(); // this is where we start out the success list
        ...
        for (int i = 0; i < childrenCount; i++)
        {
            ...
            if (child is System.Windows.FrameworkElement &&
                string.Equals((child as System.Windows.FrameworkElement).Name, controlToFindName))
            {
